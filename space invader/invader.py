...
# Player
playerImg1 = pygame.image.load('plane.png')
...
for _i in range(num_of_enemies):
    enemyImg.append(pygame.transform.scale((pygame.image.load('ufo.png')),(100,100)))
...
bulletImg = pygame.transform.scale(bulletImg1,(30,30))
bulletX = 0
